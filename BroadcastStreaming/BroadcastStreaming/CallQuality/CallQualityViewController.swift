//
//  CallQualityViewController.swift
//  BroadcastStreaming
//
...
extension CallQualityViewController: AgoraRtcEngineDelegate {
  ...
  func rtcEngine(_ engine: AgoraRtcEngineKit, remoteVideoStateChangedOfUid: UInt, state: AgoraVideoRemoteState, reason: AgoraVideoRemoteReason, elapsed: Int) {
